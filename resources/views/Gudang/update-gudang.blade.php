...
<form action="{{route('Gudang.store-gudang')}}" method="POST">
  @csrf
  <h3>Data Gudang</h3>
  ...
  <div class="form-group">
    ...
    <input name="tanggal_masuk" type="date" id="tanggal_masuk" name="tanggal_masuk" class="form-control">
  </div>
  <div class="mb-3">
    <label for="stok_barang" class="form-label">Stok Barang</label>
    <input name="stok_barang" type="text" class="form-control" id="stok_barang">
  </div>
