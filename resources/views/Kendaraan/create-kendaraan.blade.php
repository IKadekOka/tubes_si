...
<form action="{{route('Kendaraan.store-kendaraan')}}" method="POST">
  @csrf
  ...
  <div class="mb-3">
    ...
    <input name="nopol_kendaraan" type="text" class="form-control" id="nopol_kendaraan">
  </div>
  <div class="mb-3">
    <label for="jenis_mobil" class="form-label">Jenis Mobil</label>
    <input name="jenis_mobil" type="text" class="form-control" id="jenis_mobil">
  </div>
  <div>
    <label for="status_kendaraan" class="form-label">Status Kendaraan</label>
    <input name="status_kendaraan" type="text" class="form-control" id="status_kendaraan">
  </div><br>
